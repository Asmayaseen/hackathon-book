...
**اہم پیرامیٹرز**:
- **ERP (ایرر ریڈکشن پیرامیٹر)**: کنٹرول کرتا ہے کہ کتنی جلدی انٹرپینیٹریشنز کو حل کیا جاتا ہے۔ بہت زیادہ (>0.5) آسیلیشنز کا سبب بنتا ہے؛ بہت کم (<0.1) ڈھلکنے کی اجازت دیتا ہے۔ **0.2 ہیومنوائڈز کے لئے اچھی شروعات کی قیمت ہے**۔
